    ...
    class v {
      ...
      async openCommentModal(t) {
        ...
        try {
          ...
          }, m = this.container.querySelector("#wfl-comment-submit"), h = this.container.querySelector("#wfl-comment-input"), l = m.cloneNode(!0);
          m.parentNode.replaceChild(l, m), l.addEventListener("click", u);
